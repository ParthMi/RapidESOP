...
import { faGauge,faArrowRightFromBracket } from '@fortawesome/free-solid-svg-icons'
const Layout = () => {
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
          <div class="container-fluid">
            ...
            <div class="nav" id="navbarSupportedContent">
              ...
              <a class="nav-link dropdown-toggle" style={{color:"black"}} id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><button type="button" className="btn btn-dark">P</button>
              </a>
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="#!">Action</a>
                <a class="dropdown-item" href="#!">Another action</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item bg-danger p-2" style={{color:"white"}} href="#!">  Logout <FontAwesomeIcon icon={faArrowRightFromBracket} /></a>
              </div>
